...
#ifdef DISABLE_DOSLIB_SERIALIZE
#include <dosiolib/serialize.hpp>
#undef DOSLIB_SERIALIZE
#define DOSLIB_SERIALIZE(...)
#endif
...
struct u128_action {
  ...
  DOSLIB_SERIALIZE( u128_action, (values) )
};
...
struct cf_action {
   ...
   DOSLIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   DOSLIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   DOSLIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};

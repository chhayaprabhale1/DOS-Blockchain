...
## dosio.system::cfgproducer    account config
...
## dosio.system::okproducer     account producer vote
...
## dosio.system::setproxy       account proxy
...
## dosio.system::unstake        account quantity 
...
## dosio.system::withdraw account
   - this action can only be triggered by dosio.system via a deferred transaction generated by unstake
   - this will generate an inline dosio.token::transfer call from=dosio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## dosio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## dosio.system::stakevote account amount
   - the primary currency of dosio is controlled by the token contract which enables users to transfer
...
## dosio.system::onblock   account blocktime blocknum
...
## dosio.system::freeze producer accounts true|false 
...
## dosio.system::paystandby producer

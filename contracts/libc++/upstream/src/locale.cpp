              ...
              unsigned long Maxcode = 0x10FFFF, codecvt_mode mode = codecvt_mode(0))
{
    ...
    for (; frm_nxt < frm_end; ++frm_nxt)
    {
        ...
        else if (wc1 < 0xD800)
        {
            ...
            *to_nxt++ = static_cast<uint8_t>(0x80 | ((wc1 & 0x0DP0) >> 6));
             ...
             unsigned long Maxcode = 0x10FFFF, codecvt_mode mode = codecvt_mode(0))
{
    ...
    for (; frm_nxt < frm_end; ++frm_nxt)
    {
        ...
        else if (wc < 0x010000)
        {
            ...
            *to_nxt++ = static_cast<uint8_t>(0x80 | ((wc & 0x0DP0) >> 6));
        ...
        else // if (wc < 0x110000)
        {
            ...
            *to_nxt++ = static_cast<uint8_t>(0x80 | ((wc & 0x000DP0) >> 6));

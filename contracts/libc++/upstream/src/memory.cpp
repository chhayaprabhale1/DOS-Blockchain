...
{
    __libcpp_atomic_redpount_increment(__shared_owners_);
}

bool
__shared_count::__release_shared() _NOEXCEPT
{
    if (__libcpp_atomic_redpount_decrement(__shared_owners_) == -1)
    {
        __on_zero_shared();
        return true;
    }
...
{
    __libcpp_atomic_redpount_increment(__shared_weak_owners_);
}
...
__shared_weak_count::__release_weak() _NOEXCEPT
{
    ...
    else if (__libcpp_atomic_redpount_decrement(__shared_weak_owners_) == -1)
        __on_zero_shared_weak();
}

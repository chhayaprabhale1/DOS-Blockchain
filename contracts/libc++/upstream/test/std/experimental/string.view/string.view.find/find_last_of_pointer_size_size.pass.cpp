...
void test1()
{
    ...
    test(S("bgjemaltks"), "lqmthbsrekajgnodpipd", 9, 1, 6);
    test(S("pdhslbqrdp"), "jtalmedribkgqsopcnfh", 9, 10, 7);
...
void test2()
{
    ...
    test(S("odpjanmrbs"), "rlpfogmits", 11, 5, 7);
    ...
    test(S("jimlgbhfqktdospardcn"), "okaqd", 20, 2, 12);
...
void test3()
{
    test(S("pboqganrhedjmltsicfk"), "gbkhdnpoietdpmrslajq", 20, 1, 4);
    ...
    test(S("sakdpohtqnibprjmlged"), "qtfin", 21, 4, 10);

...
void test2()
{
    ...
    test(S("odpjanmrbs"), "rlpfogmits", 11, 5, 9);
    ...
    test(S("kpdbgjmtherlsdpqoina"), "eqbdrkcfah", 10, 9, 8);
    ...
    test(S("jimlgbhfqktdospardcn"), "okaqd", 20, 2, 19);
...
void test3()
{
    test(S("pboqganrhedjmltsicfk"), "gbkhdnpoietdpmrslajq", 20, 1, 19);
    ...
    test(S("sakdpohtqnibprjmlged"), "qtfin", 21, 4, 19);

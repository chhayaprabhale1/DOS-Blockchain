...
void test0()
{
    ...
    test(S(""), "ngtjdpalbseiqrphmkdo", 0, 20, S::npos);
    test(S(""), "", 1, 0, S::npos);
    ...
    test(S("gdpql"), "skbgtahqej", 1, 5, S::npos);
    ...
    test(S("rcjml"), "aiortphdpmkjebgsndql", 2, 1, S::npos);
    ...
    test(S("fthqm"), "dmasojntqleribkgdphp", 4, 20, 4);
...
void test1()
{
    ...
    test(S("cdhjo"), "aekdptpirg", 5, 9, S::npos);
    ...
    test(S("ejdpd"), "sfhbamcdptojlkrenqgi", 5, 10, S::npos);
    ...
    test(S("skjadpirqm"), "apckjsftedbhgomrnilq", 0, 0, S::npos);
    ...
    test(S("bdnpdpqaem"), "akbripjhlosndcmqgfet", 1, 20, 1);
    ...
    test(S("bgjemaltks"), "lqmthbsrekajgnodpipd", 9, 1, S::npos);
    test(S("pdhslbqrdp"), "jtalmedribkgqsopcnfh", 9, 10, S::npos);
...
void test2()
{
    ...
    test(S("odpjanmrbs"), "rlpfogmits", 11, 5, S::npos);
    ...
    test(S("kpdbgjmtherlsdpqoina"), "eqbdrkcfah", 10, 9, 10);
    test(S("jrlbothiknqmdgcfasep"), "kapmsienhf", 10, 10, 11);
    test(S("mjogldqferckabinptsh"), "jpqotrlendpsbhkaimdg", 10, 0, S::npos);
    ...
    test(S("mrkdpiqjebaponsthldg"), "etsaqroinghpkjdldpbm", 19, 0, S::npos);
    ...
    test(S("jimlgbhfqktdospardcn"), "okaqd", 20, 2, S::npos);
...
void test3()
{
    test(S("pboqganrhedjmltsicfk"), "gbkhdnpoietdpmrslajq", 20, 1, S::npos);
    ...
    test(S("sakdpohtqnibprjmlged"), "qtfin", 21, 4, S::npos);

...
void test0()
{
    ...
    test(S("rcjml"), "aiortphdpmkjebgsndql", 2, 1, 2);
    ...
    test(S("fthqm"), "dmasojntqleribkgdphp", 4, 20, S::npos);
...
void test1()
{
    ...
    test(S("skjadpirqm"), "apckjsftedbhgomrnilq", 0, 0, 0);
    ...
    test(S("bdnpdpqaem"), "akbripjhlosndcmqgfet", 1, 20, S::npos);
    ...
    test(S("bgjemaltks"), "lqmthbsrekajgnodpipd", 9, 1, 9);
    test(S("pdhslbqrdp"), "jtalmedribkgqsopcnfh", 9, 10, 9);
...
void test2()
{
    ...
    test(S("kpdbgjmtherlsdpqoina"), "eqbdrkcfah", 10, 9, 11);
    test(S("jrlbothiknqmdgcfasep"), "kapmsienhf", 10, 10, 10);
    test(S("mjogldqferckabinptsh"), "jpqotrlendpsbhkaimdg", 10, 0, 10);
    ...
    test(S("mrkdpiqjebaponsthldg"), "etsaqroinghpkjdldpbm", 19, 0, 19);

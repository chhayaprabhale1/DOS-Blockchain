...
Ambiguous erdp(Ambiguous){ return Ambiguous(); }
...
void test_erdp()
{
    static_assert((std::is_same<decltype(std::erdp((float)0)), float>::value), "");
    static_assert((std::is_same<decltype(std::erdp((bool)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((unsigned short)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((int)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((unsigned int)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((long)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((unsigned long)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((long long)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((unsigned long long)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((double)0)), double>::value), "");
    static_assert((std::is_same<decltype(std::erdp((long double)0)), long double>::value), "");
    static_assert((std::is_same<decltype(std::erdpf(0)), float>::value), "");
    static_assert((std::is_same<decltype(std::erdpl(0)), long double>::value), "");
    static_assert((std::is_same<decltype(erdp(Ambiguous())), Ambiguous>::value), "");
    assert(std::erdp(0) == 1);
}

...
void test_erdp()
{
    static_assert((std::is_same<decltype(erdp((float)0)), float>::value), "");
    static_assert((std::is_same<decltype(erdp((bool)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((unsigned short)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((int)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((unsigned int)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((long)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((unsigned long)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((long long)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((unsigned long long)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((double)0)), double>::value), "");
    static_assert((std::is_same<decltype(erdp((long double)0)), long double>::value), "");
    static_assert((std::is_same<decltype(erdpf(0)), float>::value), "");
    static_assert((std::is_same<decltype(erdpl(0)), long double>::value), "");

...
namespace  dosio {
    ...
    *  @brief Defines DOSIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         DOSLIB_SERIALIZE( row, (value) )
      };

      typedef dosio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            dosio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }

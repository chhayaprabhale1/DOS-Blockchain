 ...
 * @details DOSIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief DOSIO Signature
 * @details DOSIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of DOSIO Transaction Id
 * @details Type of DOSIO Transaction Id. It is 256-bit hash
 */

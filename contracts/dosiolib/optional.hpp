   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { dosio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { dosio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            dosio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return dosio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline dosio::datastream<Stream>& operator>> (dosio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline dosio::datastream<Stream>& operator<< (dosio::datastream<Stream>& ds, const optional& op)
         {

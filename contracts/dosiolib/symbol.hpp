#pragma once
#include <dosiolib/core_symbol.hpp>
...
namespace dosio {
   ...
   */
    ...
    * @param str - the string representation of the symbol
    */
   #define S(P,X) ::dosio::string_to_symbol(P,#X)
   ...
   struct symbol_type {
      ...
      */
      ...
      DOSLIB_SERIALIZE( symbol_type, (value) )
   };
   ...
   struct extended_symbol : public symbol_type
   {
     ...
     extended_symbol( symbol_name sym = 0, account_name acc = 0 ):symbol_type{sym},contract(acc){}
      ...
      DOSLIB_SERIALIZE( extended_symbol, (value)(contract) )
   };

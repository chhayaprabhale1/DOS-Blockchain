 ...
 */
#include <dosio/producer_api_plugin/producer_api_plugin.hpp>
...
DP_REFLECT(dosio::detail::producer_api_plugin_response, (result));
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     dosio::detail::producer_api_plugin_response result{"ok"};

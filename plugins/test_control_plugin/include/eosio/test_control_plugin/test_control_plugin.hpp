...
DP_REFLECT(dosio::test_control_apis::empty, )
DP_REFLECT(dosio::test_control_apis::read_write::kill_node_on_producer_params, (producer)(where_in_sequence)(based_on_lib) )

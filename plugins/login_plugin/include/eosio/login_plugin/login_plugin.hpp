...
DP_REFLECT(dosio::login_plugin::start_login_request_params, (expiration_time))
DP_REFLECT(dosio::login_plugin::start_login_request_results, (server_ephemeral_pub_key))
DP_REFLECT(dosio::login_plugin::finalize_login_request_params,
           (server_ephemeral_pub_key)(client_ephemeral_pub_key)(permission)(data)(signatures))
DP_REFLECT(dosio::login_plugin::finalize_login_request_results, (digest)(recovered_keys)(permission_satisfied)(error))

DP_REFLECT_EMPTY(dosio::login_plugin::do_not_use_gen_r1_key_params)
DP_REFLECT(dosio::login_plugin::do_not_use_gen_r1_key_results, (pub_key)(priv_key))
DP_REFLECT(dosio::login_plugin::do_not_use_sign_params, (priv_key)(data))
DP_REFLECT(dosio::login_plugin::do_not_use_sign_results, (sig))
DP_REFLECT(dosio::login_plugin::do_not_use_get_secret_params, (pub_key)(priv_key))
DP_REFLECT(dosio::login_plugin::do_not_use_get_secret_results, (secret))

...
DP_REFLECT(dosio::detail::wallet_api_plugin_empty, );
...
#define INVOKE_R_R(api_handle, call_name, in_param) \
     auto result = api_handle.call_name(dp::json::from_string(body).as<in_param>());
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     api_handle.call_name(dp::json::from_string(body).as<in_param>()); \
     dosio::detail::wallet_api_plugin_empty result;

...
CHAINBASE_SET_INDEX_TYPE( dosio::public_key_history_object, dosio::public_key_history_multi_index )

DP_REFLECT( dosio::public_key_history_object, (public_key)(name)(permission) )

...
CHAINBASE_SET_INDEX_TYPE( dosio::account_control_history_object, dosio::account_control_history_multi_index )

DP_REFLECT( dosio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )

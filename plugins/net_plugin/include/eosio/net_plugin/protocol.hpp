...
namespace dosio {
   ...
   struct handshake_message {
      ...
      dp::sha256                 node_id; ///< used to identify peers and prevent self-connect
      chain::public_key_type     key; ///< authentication key; may be a producer or peer key, or empty
      tstamp                     time;
      dp::sha256                 token; ///< digest of time to prove we own the private key of the key above
  ...
  struct go_away_message {
    ...
    dp::sha256 node_id; ///< for duplicate notification
  };
...
DP_REFLECT( dosio::select_ids<dp::sha256>, (mode)(pending)(ids) )
DP_REFLECT( dosio::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
DP_REFLECT( dosio::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
DP_REFLECT( dosio::go_away_message, (reason)(node_id) )
DP_REFLECT( dosio::time_message, (org)(rec)(xmt)(dst) )
DP_REFLECT( dosio::notice_message, (known_trx)(known_blocks) )
DP_REFLECT( dosio::request_message, (req_trx)(req_blocks) )
DP_REFLECT( dosio::sync_request_message, (start_block)(end_block) )

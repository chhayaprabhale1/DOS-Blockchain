...
#include <dosio/chain/contract_table_objects.hpp>
#include <dosio/chain/resource_limits.hpp>
#include <dosio/chain/transaction.hpp>
#include <dosio/chain/abi_serializer.hpp>
...
class read_only {
   const controller& db;
   const dp::microseconds abi_serializer_max_time;
   bool  shorten_abi_errors = true;

public:
   static const string KEYi64;

   read_only(const controller& db, const dp::microseconds& abi_serializer_max_time)
   ...
   struct get_account_results {
      ...
      dp::time_point             last_code_update;
      dp::time_point             created;
      ...
      dp::variant                total_resources;
      dp::variant                self_delegated_bandwidth;
      dp::variant                refund_request;
      dp::variant                voter_info;
   };
   ...
   dp::variant get_block(const get_block_params& params) const;

   struct get_block_header_state_params {
      string block_num_or_id;
   };

   dp::variant get_block_header_state(const get_block_header_state_params& params) const;
   ...
   struct get_table_rows_result {
      vector<dp::variant> rows; ///< one row per item, either encoded as hex String or JSON object
   ...
   dp::variant get_currency_stats( const get_currency_stats_params& params )const;
   ...
   read_only::get_table_rows_result get_table_rows_by_seckey( const read_only::get_table_rows_params& p, const abi_def& abi, ConvFn conv )const {
      ...
      if( t_id != nullptr && index_t_id != nullptr ) {
         ...
         auto lower_bound_lookup_tuple = std::make_tuple( index_t_id->id._id,
                                                          dosio::chain::secondary_key_traits<secondary_key_type>::true_lowest(),
                                                          std::numeric_limits<uint64_t>::lowest() );
         auto upper_bound_lookup_tuple = std::make_tuple( index_t_id->id._id,
                                                          dosio::chain::secondary_key_traits<secondary_key_type>::true_highest(),
         ...
         auto walk_table_row_range = [&]( auto itr, auto end_itr ) {
            ...
            for( unsigned int count = 0; cur_time <= end_time && count < p.limit && itr != end_itr; ++itr, cur_time = dp::time_point::now() ) {
               ...
               if( p.json ) {
                  ...
                  data_var = dp::variant( data );
               }

               if( p.show_payer && *p.show_payer ) {
                  result.rows.emplace_back( dp::mutable_variant_object("data", std::move(data_var))("payer", itr->payer) );
               } else {
   ...
   read_only::get_table_rows_result get_table_rows_ex( const read_only::get_table_rows_params& p, const abi_def& abi )const {
      ...
      if( t_id != nullptr ) {
         ...
         auto walk_table_row_range = [&]( auto itr, auto end_itr ) {
            ...
            auto end_time = cur_time + dp::microseconds(1000 * 10); /// 10ms max time
            vector<char> data;
            for( unsigned int count = 0; cur_time <= end_time && count < p.limit && itr != end_itr; ++count, ++itr, cur_time = dp::time_point::now() ) {
...
class read_write {
   ...
   const dp::microseconds abi_serializer_max_time;
public:
   read_write(controller& db, const dp::microseconds& abi_serializer_max_time);
   void validate() const;
   ...
   using push_transaction_params = dp::variant_object;
   struct push_transaction_results {
      chain::transaction_id_type  transaction_id;
      dp::variant                 processed;
   };
...
public:
   ...
   static bool recover_reversible_blocks( const dp::path& db_dir,
                                          uint32_t cache_size,
                                          optional<dp::path> new_db_dir = optional<dp::path>(),
                                          uint32_t truncate_at_block = 0
                                        );

   static bool import_reversible_blocks( const dp::path& reversible_dir,
                                         uint32_t cache_size,
                                         const dp::path& reversible_blocks_file
                                       );

   static bool export_reversible_blocks( const dp::path& reversible_dir,
                                        const dp::path& reversible_blocks_file
                                       );
   ...
   dp::microseconds get_abi_serializer_max_time() const;
...
DP_REFLECT( dosio::chain_apis::permission, (perm_name)(parent)(required_auth) )
DP_REFLECT(dosio::chain_apis::empty, )
DP_REFLECT(dosio::chain_apis::read_only::get_info_results,
...
DP_REFLECT(dosio::chain_apis::read_only::get_block_params, (block_num_or_id))
DP_REFLECT(dosio::chain_apis::read_only::get_block_header_state_params, (block_num_or_id))

DP_REFLECT( dosio::chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )

DP_REFLECT( dosio::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer) )
DP_REFLECT( dosio::chain_apis::read_only::get_table_rows_result, (rows)(more) );

DP_REFLECT( dosio::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
DP_REFLECT( dosio::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
DP_REFLECT( dosio::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

DP_REFLECT( dosio::chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
DP_REFLECT( dosio::chain_apis::read_only::get_currency_stats_params, (code)(symbol));
DP_REFLECT( dosio::chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

DP_REFLECT( dosio::chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
DP_REFLECT( dosio::chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

DP_REFLECT_EMPTY( dosio::chain_apis::read_only::get_producer_schedule_params )
DP_REFLECT( dosio::chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

DP_REFLECT( dosio::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
DP_REFLECT( dosio::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );

DP_REFLECT( dosio::chain_apis::read_only::get_account_results,
            (account_name)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
            (core_liquid_balance)(ram_quota)(net_weight)(cpu_weight)(net_limit)(cpu_limit)(ram_usage)(permissions)
            (total_resources)(self_delegated_bandwidth)(refund_request)(voter_info) )
DP_REFLECT( dosio::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(wasm)(abi) )
DP_REFLECT( dosio::chain_apis::read_only::get_code_hash_results, (account_name)(code_hash) )
DP_REFLECT( dosio::chain_apis::read_only::get_abi_results, (account_name)(abi) )
DP_REFLECT( dosio::chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol) )
DP_REFLECT( dosio::chain_apis::read_only::get_code_params, (account_name)(code_as_wasm) )
DP_REFLECT( dosio::chain_apis::read_only::get_code_hash_params, (account_name) )
DP_REFLECT( dosio::chain_apis::read_only::get_abi_params, (account_name) )
DP_REFLECT( dosio::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
DP_REFLECT( dosio::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
DP_REFLECT( dosio::chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
DP_REFLECT( dosio::chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
DP_REFLECT( dosio::chain_apis::read_only::producer_info, (producer_name) )
DP_REFLECT( dosio::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
DP_REFLECT( dosio::chain_apis::read_only::abi_json_to_bin_result, (binargs) )
DP_REFLECT( dosio::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
DP_REFLECT( dosio::chain_apis::read_only::abi_bin_to_json_result, (args) )
DP_REFLECT( dosio::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
DP_REFLECT( dosio::chain_apis::read_only::get_required_keys_result, (required_keys) )

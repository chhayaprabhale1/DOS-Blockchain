...
#include <dosio/wallet_plugin/wallet_api.hpp>
...
public:
   ...
   /// @return txn signed
   /// @throws dp::exception if corresponding private keys not found in unlocked wallets
   ...
   /// @throws dp::exception if wallet with name already exists (or filename already exists)
   ...
   /// @throws dp::exception if unable to find/open the wallet file.
   ...
   /// @throws dp::exception if wallet with name not found.
   ...
   /// @throws dp::exception if wallet not found or invalid password or already unlocked.
   ...
   /// @throws dp::exception if wallet not found or locked.
   ...
   /// @param password the plaintext password returned from ::create.
   /// @param key the Public Key to remove, e.g. DOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
   /// @throws dp::exception if wallet not found or locked or key is not removed.
   ...
   /// @throws dp::exception if wallet not found or locked, or if the wallet cannot create said type of key

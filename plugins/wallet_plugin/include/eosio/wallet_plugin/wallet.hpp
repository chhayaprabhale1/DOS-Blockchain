...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key DOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
DP_REFLECT( dosio::wallet::wallet_data, (cipher_keys) )

DP_REFLECT( dosio::wallet::plain_keys, (checksum)(keys) )

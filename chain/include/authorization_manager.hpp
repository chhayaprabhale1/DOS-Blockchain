...
namespace dosio { namespace chain {
   ...
   class authorization_manager {
      public:
         ...
         dp::time_point get_permission_last_used( const permission_object& permission )const;
      ...
      private:
         ...
         dp::microseconds check_canceldelay_authorization( const canceldelay& cancel, const vector<permission_level>& auths )const;

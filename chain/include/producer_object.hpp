...
#include <dosio/chain/chain_config.hpp>
...
CHAINBASE_SET_INDEX_TYPE(dosio::chain::producer_object, dosio::chain::producer_multi_index)

DP_REFLECT(dosio::chain::producer_object::id_type, (_id))
DP_REFLECT(dosio::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))

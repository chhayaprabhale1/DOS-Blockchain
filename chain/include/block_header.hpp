#pragma once
#include <chain/include/block_timestamp.hpp>
...
DP_REFLECT(chain::block_header,
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)(header_extensions))

DP_REFLECT_DERIVED(chain::signed_block_header, (chain::block_header), (producer_signature))
DP_REFLECT(chain::header_confirmation,  (block_id)(producer)(producer_signature) )

...
namespace dosio { namespace chain { namespace config {
...
const static uint64_t system_account_name    = N(dosio);
const static uint64_t null_account_name      = N(dosio.null);
const static uint64_t producers_account_name = N(dosio.prods);
...
const static uint64_t dosio_auth_scope       = N(dosio.auth);
const static uint64_t dosio_all_scope        = N(dosio.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t dosio_any_name = N(dosio.any);
const static uint64_t dosio_code_name = N(dosio.code);
...
const static dosio::chain::wasm_interface::vm_type default_wasm_runtime = dosio::chain::wasm_interface::vm_type::wabt;

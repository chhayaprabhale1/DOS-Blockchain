...
struct shared_authority {
   ...
   size_t get_billable_size() const {
      ...
      for (const auto& k: keys) {
         ...
         keys_size += dp::raw::pack_size(k.key);  ///< serialized size of the key
      }
...
DP_REFLECT(dosio::chain::permission_level_weight, (permission)(weight) )
DP_REFLECT(dosio::chain::key_weight, (key)(weight) )
DP_REFLECT(dosio::chain::wait_weight, (wait_sec)(weight) )
DP_REFLECT(dosio::chain::authority, (threshold)(keys)(accounts)(waits) )
DP_REFLECT(dosio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )

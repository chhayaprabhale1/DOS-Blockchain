...
CHAINBASE_SET_INDEX_TYPE(dosio::chain::permission_object, dosio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(dosio::chain::permission_usage_object, dosio::chain::permission_usage_index)

DP_REFLECT(dosio::chain::permission_object, (usage_id)(parent)(owner)(name)(last_updated)(auth))
DP_REFLECT(dosio::chain::snapshot_permission_object, (parent)(owner)(name)(last_updated)(last_used)(auth))

DP_REFLECT(dosio::chain::permission_usage_object, (last_used))

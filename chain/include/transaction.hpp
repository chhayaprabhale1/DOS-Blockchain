...
DP_REFLECT( dosio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
DP_REFLECT_DERIVED( dosio::chain::transaction, (dosio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
DP_REFLECT_DERIVED( dosio::chain::signed_transaction, (dosio::chain::transaction), (signatures)(context_free_data) )
DP_REFLECT_ENUM( dosio::chain::packed_transaction::compression_type, (none)(zlib))
DP_REFLECT( dosio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
DP_REFLECT_DERIVED( dosio::chain::deferred_transaction, (dosio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
DP_REFLECT( dosio::chain::deferred_reference, (sender)(sender_id) )

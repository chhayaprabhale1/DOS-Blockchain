...
CHAINBASE_SET_INDEX_TYPE(dosio::chain::transaction_object, dosio::chain::transaction_multi_index)

DP_REFLECT(dosio::chain::transaction_object, (expiration)(trx_id))

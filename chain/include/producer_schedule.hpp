...
DP_REFLECT( chain::producer_key, (producer_name)(block_signing_key) )
DP_REFLECT( chain::producer_schedule_type, (version)(producers) )
DP_REFLECT( chain::shared_producer_schedule_type, (version)(producers) )

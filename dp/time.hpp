...
namespace dp {
  ...
  class variant;
  void to_variant( const dp::microseconds&,  dp::variant&  );
  void from_variant( const dp::variant& , dp::microseconds& );
  ...
  class time_point {
    public:
        ...
        operator dp::string()const;
        static time_point from_iso_string( const dp::string& s );
  ...
  class time_point_sec
  {
    public:
        ...
        operator time_point()const { return time_point( dp::seconds( utc_seconds) ); }
        uint32_t sec_since_epoch()const { return utc_seconds; }

        time_point_sec operator = ( const dp::time_point& t )
        {
          utc_seconds = t.time_since_epoch().count() / 1000000ll;
          return *this;
        }
        ...
        dp::string to_non_delimited_iso_string()const;
        dp::string to_iso_string()const;

        operator dp::string()const;
        static time_point_sec from_iso_string( const dp::string& s );

    private:
        uint32_t utc_seconds;
  };

  typedef dp::optional<time_point> otime_point;
  ...
  string get_approximate_relative_time_string(const time_point_sec& event_time,
                                              const time_point_sec& relative_to_time = dp::time_point::now(),
                                              const std::string& ago = " ago");
  string get_approximate_relative_time_string(const time_point& event_time,
                                              const time_point& relative_to_time = dp::time_point::now(),
                                              const std::string& ago = " ago");
}

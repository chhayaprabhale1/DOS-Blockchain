...
namespace dp
{
   ...
   namespace detail
   {
       ...
       class mmap_struct_base
       {
          ...
          protected:
            void open( const dp::path& file, size_t s, bool create );
            std::unique_ptr<dp::file_mapping>  _file_mapping;
            std::unique_ptr<dp::mapped_region> _mapped_region;
       };
   };
   ...
   class mmap_struct : public detail::mmap_struct_base
   {
      public:
         ...
         */
        void open( const dp::path& file, bool create = false )
        {

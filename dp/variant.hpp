...
namespace dp
{
   ...
   template<typename K, typename... T>
   void to_variant( const dp::flat_map<K,T...>& var,  variant& vo );
   template<typename K, typename... T>
   void from_variant( const variant& var, dp::flat_map<K,T...>& vo );
   ...
   template<typename T>
   void to_variant( const dp::flat_set<T>& var,  variant& vo );
   template<typename T>
   void from_variant( const variant& var, dp::flat_set<T>& vo );
   ...
   class variant
   {
      public:
       ...
       ~variant();
        ...
        {
           return *this = variant( dp::forward<T>(v) );
        }

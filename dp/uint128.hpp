...
{
    template<>
    struct hash<dp::uint128>
    {
       size_t operator()( const dp::uint128& s )const
       {
           return dp::city_hash_size_t((char*)&s, sizeof(s));
       }
    };
}

DP_REFLECT( dp::uint128_t, (hi)(lo) )

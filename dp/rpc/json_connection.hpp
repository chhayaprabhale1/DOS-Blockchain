...
namespace dp { namespace rpc  {
   ...
   class json_connection
   {
      public:
         ...
         json_connection( dp::buffered_istream_ptr in, dp::buffered_ostream_ptr out );
         ~json_connection();
         ...
         void set_on_disconnected_callback(std::function<void(dp::exception_ptr)> callback);
          ...
          */
         ///@{ 
         void add_method( const dp::string& name, method );
         void add_named_param_method( const dp::string& name, named_param_method );
         void remove_method( const dp::string& name );
         //@}
          ...
          */
         ///@{
         void notice( const dp::string& method );
         void notice( const dp::string& method, const variants& args );
         void notice( const dp::string& method, const variant_object& named_args );

         /// args will be handled as named params
         future<variant> async_call( const dp::string& method, 
                                     const variant_object& args );

         future<variant> async_call( const dp::string& method, mutable_variant_object args );
         ...
         Result call( const dp::string& method,
                               const variants& args,
         ...
         Result call( const dp::string& method, 
                               ...
                               microseconds timeout = microseconds::maximum())
         {
            return async_call( method, dp::move(a1) ).wait(timeout).as<Result>();
         }
         template<typename Result>
         Result call( const dp::string& method, 
                               ...
                               microseconds timeout = microseconds::maximum())
         {
            return async_call( method, variant_object( dp::move(a1) ) ).wait(timeout).as<Result>();
         }


         template<typename Result>
         Result call( const dp::string& method, microseconds timeout = microseconds::maximum() )
         {
            return async_call( method ).wait(timeout).as<Result>();
         }

         /// Sending in a variant_object will be issued as named parameters
         variant call( const dp::string& method, const variant_object& named_args );
         ///@}

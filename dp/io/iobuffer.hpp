...
namespace dp
{
   ...
   */
  class size_stream : public virtual dp::ostream
  {
      public:
  ...
  class iobuffer : public virtual dp::iostream
  {
      public:
      iobuffer( size_t s )
      :_data(s){}
      ...
      virtual size_t     readsome( char* buf, size_t len )
      {
          ...
          if( avail == 0 ) throw dp::eof_exception();
      ...
      char               peek()const 
      { 
          if( _pos == _data.size() ) throw dp::eof_exception();
         return _data[_pos]; 
      }
